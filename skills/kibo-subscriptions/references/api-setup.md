...
- **Don't do storefront work over admin REST.** Cart merging, anonymous shopper tickets, and price-list resolution depend on `x-vol-user-claims` and the site-aware hostname. Admin REST loses all of that.
